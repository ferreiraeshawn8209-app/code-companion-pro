  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center font-mono">
        <div className="text-primary text-sm">$ cat /var/log/404</div>
        <h1 className="mt-4 text-7xl font-bold text-primary text-glow">404</h1>
        <h2 className="mt-4 text-xl text-foreground">route not found</h2>
        <p className="mt-2 text-sm text-muted-foreground">
          The URL you requested doesn't map to any handler.
        </p>
        <div className="mt-6">
          <Link
            to="/"
            className="inline-flex items-center justify-center rounded-md bg-primary px-4 py-2 text-sm font-medium text-primary-foreground transition-all hover:glow"
          >
            $ cd ~
          </Link>
        </div>
...
function ErrorComponent({ error, reset }: { error: Error; reset: () => void }) {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center font-mono">
        <div className="text-destructive text-sm">$ ./run --failed</div>
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          <button
            ...
            className="inline-flex items-center justify-center rounded-md bg-primary px-4 py-2 text-sm font-medium text-primary-foreground hover:glow"
          >
            retry
          </button>
          <a
